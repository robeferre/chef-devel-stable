...
when 'rhel'
   ...
   default['ihs8551']['zip']['location1']	= "/install/CHEF_FILES/LINUX/IHS/IHS_85/8.5.5-WS-WASSupplements-FP0000001-part1.zip"
   default['ihs8551']['zip']['location2']	= "/install/CHEF_FILES/LINUX/IHS/IHS_85/8.5.5-WS-WASSupplements-FP0000001-part2.zip"
...
when 'aix'
   ...
   #IHS
   default['ihs8551']['base']['path']		= "/usr/IBM/HTTPServer"
   ...
   default['ihs8551']['response']['erb']	= "ihs_8551_aix.rsp.erb"
   default['ihs8551']['response']['file']	= "ihs_8551_aix.rsp"
