...
config_cache  = node['was8502']['cache_path']
im_tools_path = node['was8502']['im_tools_path']
im_cache_path = node['was8502']['im_cache_path']
response_path = node['was8502']['cache_path'] + "/was8502_response_file.rsp"
was_install_log = node['was8502']['cache_path'] + "/WASUpdate.log"
was_dynamic_url1  = "http://#{$BEST_SERVER}#{node['was8502']['package1_url']}"
was_dynamic_url2  = "http://#{$BEST_SERVER}#{node['was8502']['package2_url']}"
was_package_file1 = node['was8502']['package_file1']  
was_package_file2 = node['was8502']['package_file2']
...
template response_path do
    source "was8502_response_file.rsp.erb"
    owner  'dstadmin'
    group  'dstadmin'
    mode   0755
    action :touch
...
execute "Updating WAS to v8.5.0.2 ..." do
  user "root"
