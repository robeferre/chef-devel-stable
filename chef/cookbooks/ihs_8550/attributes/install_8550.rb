...
when 'rhel'
   ...
   default['ihs8550']['zip']['location1']	= "/install/CHEF_FILES/LINUX/IHS/IHS_85/WAS_V8.5.5_SUPPL_1_OF_3.zip"
   default['ihs8550']['zip']['location2']	= "/install/CHEF_FILES/LINUX/IHS/IHS_85/WAS_V8.5.5_SUPPL_2_OF_3.zip"
   default['ihs8550']['zip']['location3']	= "/install/CHEF_FILES/LINUX/IHS/IHS_85/WAS_V8.5.5_SUPPL_3_OF_3.zip"
...
when 'aix'
   ...
   #IHS
   default['ihs8550']['base']['path']		= "/usr/IBM/HTTPServer"
   ...
   default['ihs8550']['response']['erb']	= "ihs_8550_aix.rsp.erb"
   default['ihs8550']['response']['file']	= "ihs_8550_aix.rsp"
