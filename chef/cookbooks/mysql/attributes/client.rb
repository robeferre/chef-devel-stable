...
when 'rhel', 'fedora'
  ...
  default['mysql']['client']['singlepkg_name'] = "MySQL-client-5.6.17-1"
  default['mysql']['client']['singlepkg_url'] = "http://dst.lexington.ibm.com/install/CHEF_FILES/MY_SQL/MySQL-client-5.6.17-1.el6.x86_64.rpm"
when 'suse'
