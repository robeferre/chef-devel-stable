...
when 'aix'
  ...
  # cache dir
  default['mysql']['server']['cache'] = Chef::Config[:file_cache_path] + "/mysql_install"
  
  # package url
  default['mysql']['server']['url'] = 'http://dst.lexington.ibm.com/install/CHEF_FILES/MY_SQL/mysql-server-5.6.16.1.x86_64.rpm'
  default['mysql']['connector']['url'] = 'http://dst.lexington.ibm.com/install/CHEF_FILES/MY_SQL/mysql-connector-odbc-5.2.6-1.x86_64.rpm' 
  default['mysql']['server']['file'] = "mysql-server-5.6.16.1.x86_64.rpm"
  default['mysql']['connector']['file'] = "mysql-connector-odbc-5.2.6-1.x86_64.rpm"
  
  # package versions
  default['mysql']['server']['packages'] = ['mysql-server-5.6.16.1.x86_64.rpm','mysql-connector-odbc-5.2.6-1.x86_64.rpm']
  ...
  # RHEL/CentOS/AIX mysql package does not support this option.
