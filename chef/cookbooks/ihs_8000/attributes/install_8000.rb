...
when 'rhel'
   ...
   default['ihs8000']['zip']['location1']	= "/install/CHEF_FILES/LINUX/IHS/IHS_80/WASV8.0_SUPPL_1_OF_4_MP_ML.zip"
   default['ihs8000']['zip']['location2']	= "/install/CHEF_FILES/LINUX/IHS/IHS_80/WAS_V8.0_SUPPL_2_OF_4_MP_ML.zip"
   default['ihs8000']['zip']['location3']	= "/install/CHEF_FILES/LINUX/IHS/IHS_80/WAS_V8.0_SUPPL_3_OF_4_MP_ML.zip"
   default['ihs8000']['zip']['location4']	= "/install/CHEF_FILES/LINUX/IHS/IHS_80/WASV8.0_SUPPL_4_OF_4_MP_ML.zip"
...
when 'aix'
   ...
   #IHS
   default['ihs8000']['base']['path']		= "/usr/IBM/HTTPServer"
   ...
   default['ihs8000']['response']['erb']	= "ihs_8000_aix.rsp.erb"
   default['ihs8000']['response']['file']	= "ihs_8000_aix.rsp"
