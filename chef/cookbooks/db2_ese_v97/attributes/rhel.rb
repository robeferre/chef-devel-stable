...
when 'rhel'
  ...
  #db2
  default['db2']['package']['file'] = "db2-v97-ese-x64.tar.gz"
  default['db2']['package']['url'] = "/install/CHEF_FILES/DB2/V97/db2-v97-ese-x64.tar.gz"
  default['db2']['install']['cache'] = "#{node['db2']['cache']}/db2-v97-ese-x64/"
