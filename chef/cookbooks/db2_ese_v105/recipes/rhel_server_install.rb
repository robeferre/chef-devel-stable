...
# Cookbok: DB2 v10.5
#
# Created by: Daniel Abraao Silva Costa (dasc@br.ibm.com)
#
...
if (!(File.directory?(node['db2']['main']['path'])))
  ...
  execute "Installing DB2 v10.5 Silenty ..." do
    user "root"
    cwd db2_cache_path
  ...
  execute "Activating the DB2 v10.5 license ..." do
    user "root"
  ...
  execute "Listing DB2 v10.5 license ..." do
    user "root"
    cwd node['db2']['adm']['path']
    command "./db2licm -l"
    action :run
