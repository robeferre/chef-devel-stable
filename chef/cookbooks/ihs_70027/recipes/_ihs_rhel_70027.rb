...
include_recipe 'ihs_70027::_updateInst_rhel_70'
...
#############################
	...
	execute "Aplly the fixpack27" do
	  ...
	  command "./update.sh -options #{node['ihs70027']['config']['cache']}/#{node['ihs70027']['response']['file']} -silent"
 	  action :run
	end
